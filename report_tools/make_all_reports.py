...
def collect_row(root: Path, result_dir: Path) -> dict:
    ...
    aliases = {
        ...
        "spanning_radius_lr_m": [
            "topological_morphology_building_footprints.spanning_radius_lr_recommended_m",
            "topological_morphology_building_footprints.spanning_radius_lr_m",
        ],
        "spanning_radius_tb_m": [
            "topological_morphology_building_footprints.spanning_radius_tb_recommended_m",
            "topological_morphology_building_footprints.spanning_radius_tb_m",
        ],
        "spanning_reference_recommended": [
            "topological_morphology_building_footprints.spanning_reference_recommended",
        ],
        "domain_component_count": [
            "topological_morphology_building_footprints.domain_component_count",
        ],
        "largest_domain_component_fraction": [
            "topological_morphology_building_footprints.largest_domain_component_fraction",
        ],
        ...
        "archipelago_index_norm": [
            "topological_morphology_building_footprints.archipelago_index_per_component",
        ],
        "void_index_norm": [
            "topological_morphology_building_footprints.void_index_per_component",
        ],
        "boundary_complexity_norm": [
            "topological_morphology_building_footprints.boundary_index_per_characteristic_length",
        ],
        "topology_radius_min_m": [
            "topological_morphology_building_footprints.topology_radius_min_positive_m",
        ],
        "topology_radius_max_m": [
            "topological_morphology_building_footprints.topology_radius_max_m",
        ],
        "topology_log_radius_span": [
            "topological_morphology_building_footprints.topology_log_radius_span",
        ],
    }
