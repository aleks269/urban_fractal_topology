...
def make_markdown(results_dir: Path, city: str) -> str:
    ...
    lines.append("- Не смешивать `giant_component_radius_m` с направленными `spanning_radius_lr_m` и `spanning_radius_tb_m`.")
...
<li>Не смешивать <code>giant_component_radius_m</code> с направленными <code>spanning_radius_lr_m</code> и <code>spanning_radius_tb_m</code>.</li>
