...
def main() -> int:
    ...
    for city in catalog:
        ...
        if result_complete:
            ...
            if not topo or (
                "spanning_radius_lr_recommended_m" not in topo
                and "spanning_radius_lr_m" not in topo
            ):
            ...
            if topo.get("normalized_indices_radius_interval_comparable") is False:
                warnings.append("topology_radius_interval_requires_harmonization")
            if qc.get("multifractal_footprint_monotonic_within_uncertainty") is False:
                warnings.append("multifractal_footprint_qc_failed")
            if qc.get("multifractal_height_weighted_intercity_eligible") is False:
                warnings.append("multifractal_height_weighted_not_intercity_eligible")
        ...
        rows.append({
            ...
            "spanning_radius_lr_m": topo.get("spanning_radius_lr_recommended_m", topo.get("spanning_radius_lr_m")),
            "spanning_radius_tb_m": topo.get("spanning_radius_tb_recommended_m", topo.get("spanning_radius_tb_m")),
            "spanning_reference_recommended": topo.get("spanning_reference_recommended"),
            "domain_component_count": topo.get("domain_component_count"),
            "largest_domain_component_fraction": topo.get("largest_domain_component_fraction"),
            "topology_radius_min_m": topo.get("topology_radius_min_positive_m"),
            "topology_radius_max_m": topo.get("topology_radius_max_m"),
