...
from .raster import rasterize_geometries, rasterize_like
...
def analyze_city(cfg: AnalysisConfig) -> dict[str, Any]:
    ...
    if cfg.multifractal:
        ...
        spectrum, raw_mf = multifractal_spectrum_2d(
            building_mask.astype(float), box_sizes, q_values, cfg.pixel_size_m, min_points=cfg.min_scaling_points
        )
    ...
    result = {
        ...
        "method_notes": [
            ...
            "Giant-component radius and true directional boundary-spanning radii are reported separately.",
            "Multifractal probabilities are normalized after zero padding at every scale; the input mass is never cropped.",
